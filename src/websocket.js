...
module.exports = function (onStart = _onOpen, onStop = _onClose) {
  ...
  diagnosticCollection =
    vscode.languages.createDiagnosticCollection("DroidScript Errors");
...
const createWebSocket = function (
  /** @type {(this: WebSocket) => void} */ onOpen,
  /** @type {(this: WebSocket, data: WebSocket.RawData, isBinary: boolean) => void} */ onMessage,
  /** @type {(this: WebSocket, code: number, reason: Buffer) => void} */ onClose,
  /** @type {(this: WebSocket, err: Error) => void} */ onError
) {
