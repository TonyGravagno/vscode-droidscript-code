...
- Catch up with the [Change Log](./CHANGELOG.md) and [Highlights](./Highlights.md).
- Run package.json script `build`. This generates droidscript-code-0.3.6.vsix.
...
To run while in development mode, you can F5/ctrl-F5 to launch an Extension Development Host - a new VSCode window that has the extension installed and is ready to work with your devices. Use the normal VSCode run/Restart (ctrl-shift-F5) to reload the new window with extension code changes.

## Making Changes

This project can't provide the information required for working with VSCode extensions. You need to get that [education](https://code.visualstudio.com/api) from common sources. Continue here after you feel competent to modify a VSCode extension.
...
Update code in your branch, PR to origin.
