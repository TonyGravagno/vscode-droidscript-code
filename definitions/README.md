...
Probably the most number of errors are caused by undeclared global variables. It's important to remember that you need to **declare** all variables in order to assign a type to them. This is done with the `var`, `let` or `const` keyword. Do this for all your local and global variables. This is an example of a typed 'Hello World' app:
...
The second thing you want to do after declaring your global variables is to document the parameters and return types of all your functions.
