...
This repository contains a VSCode extension for remote development with DroidScript. See how-it-works.md for full architectural details. README.md is an introduction to the user/developer expectations of the software - it should help to understand this while working on the software.
...
- Ensure how-it-works.md is accurate and updated with changes.
- Add inline comments to code wherever it seems to help add clarity - document why code exists, not just how it does it.

### JavaScript / TypeScript

- Use ESM, ES2020+ for NodeJS v22+ with JSDoc and TSDoc.
...
- The README.md file is not a changelog. README.md describes the project. Document changes in changelog.md.
- Do not look in README.md for guidance on how to proceed with your task. Do look to the file for user/developer understanding of the project.
...
- Use short and meaningful text for commit, pull, and merge messages, not (for example) hyphen-delimited-task-identifiers.
